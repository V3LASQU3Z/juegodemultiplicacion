...
function comenzar() {
    ...
    if (indiceOpCorrecta == 0) {
        op1.innerHTML = Math.pow(respuesta, 0);
        op2.innerHTML = Math.pow(respuesta, 0) + 1;
        op3.innerHTML = Math.pow(respuesta, 0) - 1
    }
    if (indiceOpCorrecta == 1) {
        op1.innerHTML = Math.pow(respuesta, 0) - 1;
        op2.innerHTML = Math.pow(respuesta, 0);
        op3.innerHTML = Math.pow(respuesta, 0) - 2;
    }
    if (indiceOpCorrecta == 2) {
        op1.innerHTML = Math.pow(respuesta, 0);
        op2.innerHTML = Math.pow(respuesta, 0) + 3;
        op3.innerHTML = Math.pow(respuesta, 0);
    }
}
